...
//                                        Utils.popupMessageSuccess(LoginActivity.this, "The reset link has been sent.");
...
//                                        Utils.popupMessageFailure(LoginActivity.this, "There is no account with this email. Please make an account.");
                                        break;

                                    case "The email address is badly formatted.":
//                                        Utils.popupMessageFailure(LoginActivity.this, "Please enter a valid email address.");
                                        break;
                                }
                            }
                        });
...
//            Utils.popupMessageFailure(LoginActivity.this, "Please enter a valid username and/or password.");
            return;
        }
...
//                                    Utils.popupMessageFailure(LoginActivity.this, "The authentication credential is malformed or expired.");
                                    break;
...
//                                    Utils.popupMessageFailure(LoginActivity.this, "The password entered is incorrect.");
                                    mTxtPassword.setText("");
                                    break;

                                case "ERROR_USER_MISMATCH":
//                                    Utils.popupMessageFailure(LoginActivity.this, "The supplied credentials do not correspond to the previously signed in user.");
                                    break;

                                case "ERROR_REQUIRES_RECENT_LOGIN":
//                                    Utils.popupMessageFailure(LoginActivity.this, "This operation is sensitive and requires recent authentication. Log in again before retrying this request.");
                                    break;

                                case "ERROR_ACCOUNT_EXISTS_WITH_DIFFERENT_CREDENTIAL":
//                                    Utils.popupMessageFailure(LoginActivity.this, "An account already exists with the same email address but different sign-in credentials.");
                                    break;
...
//                                    Utils.popupMessageFailure(LoginActivity.this, "This email is already associated with a different account.");
                                    break;

                                case "ERROR_USER_DISABLED":
//                                    Utils.popupMessageFailure(LoginActivity.this, "This account has been disabled by an administrator");
                                    break;

                                case "ERROR_USER_TOKEN_EXPIRED":
//                                    Utils.popupMessageFailure(LoginActivity.this, "User's credentials have expired. Please sign in again");
                                    break;

                                case "ERROR_USER_NOT_FOUND":
//                                    Utils.popupMessageFailure(LoginActivity.this, "There is no account with this email. Please create an account.");
                                    break;

                                case "ERROR_INVALID_USER_TOKEN":
//                                    Utils.popupMessageFailure(LoginActivity.this, "Please sign in again");
                                    break;

                                case "ERROR_OPERATION_NOT_ALLOWED":
//                                    Utils.popupMessageFailure(LoginActivity.this, "This operation is not allowed.");
                                    break;
